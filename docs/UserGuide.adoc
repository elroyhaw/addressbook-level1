...
[NOTE]
====
The name refers to the targeted name of person to be deleted.
====
...
* `list` +
`delete Alice` +
Deletes the first person with name Alice in the address book.

* `delete Charlie Dickson`
Deletes Charlie Dickson but not Charlie, Dickson or charlie dickson.
