...
public class AddressBook {
     ...
     * The constants given below are the key values for the different data elements of a person
     * used by the internal HashMap<PersonProperty, String> storage format.
     * For example, a person's name is stored as the value of the key: PersonProperty.NAME.
     */
